...
def load_memory():
    ...
    if os.path.exists(MEMORY_FILE):
        with open(MEMORY_FILE, "r") as f:
            ...
            # 💣 FIX: eksik alanları tamamla
            for t in active_trades:
                t.setdefault("tp", t.get("entry", 0) * 1.02)
                t.setdefault("sl", t.get("entry", 0) * 0.98)
                t.setdefault("lot", 1)
...
print("AI TRADER V29.1 FIX CALISIYOR...")
send("🤖 V29.1 SAFE FIX AKTİF")
