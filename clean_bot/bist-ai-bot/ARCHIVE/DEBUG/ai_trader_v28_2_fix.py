...
def is_active(symbol):
    return any(t["symbol"] == symbol for t in active_trades)
...
print("AI TRADER V28.2 FIX CALISIYOR...")
send("🧠 V28.2 ANTI-SPAM AKTİF")
    ...
    try:
            ...
            for u in updates["result"]:
                ...
                if "message" in u:
                    ...
                    if text == "YES" and pending_trade:
                        ...
                        cooldown[pending_trade["symbol"]] = time.time()
        ...
        if pending_trade is None:
            ...
            for s in symbols:
                ...
                pending_trade = {"symbol": s, "lot": lot}
