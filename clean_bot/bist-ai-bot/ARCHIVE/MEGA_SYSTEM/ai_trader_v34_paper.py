...
def load_memory():
    global locked_symbols, symbols, weights, risk_pct
...
print("AI TRADER V34 PAPER TRADING CALISIYOR...")
send("📊 V34 PAPER TRADING AKTİF")
...
while True:
    try:
        ...
        for s in symbols:
            ...
            scalp_score = (move > 0)*3 + (abs(move) > atr_v * 0.2)*3
