...
print("AI TRADER V31 MULTI STRATEGY CALISIYOR...")
send("🧠 V31 MULTI STRATEGY AKTİF")
...
while True:
    try:
        ...
        for s in symbols:
            ...
            # ================= SCALP =================
            recent_move = float(df["Close"].iloc[-1] - df["Close"].iloc[-2])

            scalp_score = 0
            if recent_move > 0: scalp_score += 3
            if abs(recent_move) > atr_v * 0.2: scalp_score += 3
