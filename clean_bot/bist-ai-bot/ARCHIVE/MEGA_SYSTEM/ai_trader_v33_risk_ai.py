...
def load_memory():
    global active_trades, locked_symbols, symbols, weights, risk_pct
    ...
    if os.path.exists(MEMORY_FILE):
        with open(MEMORY_FILE, "r") as f:
            ...
            risk_pct = data.get("risk_pct", 0.005)
...
print("AI TRADER V33 RISK AI CALISIYOR...")
send("🧠 V33 RISK AI AKTİF")
