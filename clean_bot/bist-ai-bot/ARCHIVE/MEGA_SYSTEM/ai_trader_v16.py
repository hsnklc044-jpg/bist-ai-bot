...
def market_is_bad():
    ...
    return ratio >= 0.6  # %60 düşüş varsa kötü piyasa

print("AI TRADER V16 MARKET AI CALISIYOR...")
send("🧠 V16 MARKET RISK AKTİF")
...
while True:
    try:
        ...
        # 💣 MARKET CHECK
        if market_is_bad():
            send("⛔ PİYASA KÖTÜ - TRADE DURDU")

            # açık işlemleri kapat
            for t in active_trades:
                send(f"⚠️ EXIT {t['symbol']} MARKET RISK")
