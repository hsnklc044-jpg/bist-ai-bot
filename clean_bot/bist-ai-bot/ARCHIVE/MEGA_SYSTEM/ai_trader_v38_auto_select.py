...
"ASELS","PETKM","GARAN","YKBNK","SAHOL","PGSUS","KOZAL"
]
...
def select_best_symbols():
    ...
    best = [x[0] for x in scores[:3]]

    send(f"📊 TOP 3: {best}")

    return best

print("V38 AUTO STOCK AI CALISIYOR...")
send("🧠 V38 AUTO STOCK SELECTION AKTİF")
...
while True:
    try:
        ...
        if best_trade and len(active_trades) < MAX_TRADES:
            ...
            send(f"🚀 {mode} BEST TRADE {best_trade['symbol']} Lot:{best_trade['lot']}")
