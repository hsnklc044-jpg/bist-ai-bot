...
def analyze(s):
    ...
    # 🔥 EARLY ENTRY FILTER (geç kalma engeli)
...
def manage():
    ...
    for s,positions in list(state.items()):
        ...
        for t in positions[:]:
            ...
            # 🔥 BREAK EVEN
            if not t["be_moved"]:
                if t["side"]=="LONG" and p > t["entry"]*1.003:
                    t["sl"]=t["entry"]
                    t["be_moved"]=True
                elif t["side"]=="SHORT" and p < t["entry"]*0.997:
                    t["sl"]=t["entry"]
                    t["be_moved"]=True
