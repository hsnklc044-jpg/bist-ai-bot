...
# 🔥 PROFIT LOCK
BREAKEVEN_TRIGGER = 0.5   # %0.5 kârda SL entry
TRAIL_TRIGGER = 1.0       # %1 kârda trailing başlar
TRAIL_STEP = 0.4          # %0.4 trailing mesafe
...
# ================= MAIN =================
def run():
    print("🚀 v174 PROFIT LOCK SYSTEM")

    send("✅ BOT STARTED v174")
