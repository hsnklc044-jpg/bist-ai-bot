# =========================================
# FILE: v1111_ULTRA_PRO_TREND_RIDER.py
# =========================================
...
print("🚀 TREND RIDER ENGINE STARTED")
...
while True:
    ...
    for s, price, atr, score, side in signals:
        ...
        positions[s] = {
            ...
            "atr": atr,
            "size": size,
            "trail_mult": 1.5  # 🔥 trend uzadıkça gevşer
        }
    ...
    for s in list(positions.keys()):
        ...
        # 🔥 TRAIL MULTIPLIER BÜYÜR (trend varsa)
        if pnl > atr * size:
            pos["trail_mult"] = 2.5
        elif pnl > atr * size * 2:
            pos["trail_mult"] = 3.5
        ...
        if side == "LONG":
            trailing = price - atr * pos["trail_mult"]
            exit_cond = price < trailing
