...
def get_signal(symbol):
    ...
    print(f"{symbol} TREND:{trend} EMA9:{round(e9,2)} EMA21:{round(e21,2)} RSI:{round(r,2)} STR:{round(strength,6)}")

    # 🔥 AGGRESSIVE CHOP
    if strength < 0.00015:
        print("BLOCK: ultra chop")
        return None

    # RSI DARALTILDI
    if 48 < r < 52:
        print("BLOCK: tight rsi")
        return None

    # SIGNAL
    if trend == "LONG" and e9 > e21 and r > 49:
        return "LONG"

    if trend == "SHORT" and e9 < e21 and r < 51:
        return "SHORT"
...
# ================= ENGINE ===================
def run():
    print("🚀 v128.3 PRO (AGGRESSIVE SYSTEM)")
