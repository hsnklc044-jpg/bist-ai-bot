...
def analyze(symbol):
    ...
    try:
        ...
        # 🎯 DENGELİ PRO FİLTRE
        if trend_up and (mom_up or vol_ok) and 50 < rsi_val < 60:
            direction = "LONG"
        elif trend_down and (mom_down or vol_ok) and 40 < rsi_val < 50:
            direction = "SHORT"
        else:
            return None
