# =========================================
# FILE: v1132_PRO_SMART_DECISION_ENGINE_FIXED.py
# =========================================
...
print("🚀 v1132 PRO DECISION ENGINE (FIXED) STARTED")
...
while True:
    ...
    for s in list(positions.keys()):
        ...
        trailing = pos["max_price"] - (atr_val * trail_multiplier)
        ...
        # ✅ sadece kârdayken trailing çalışır
