...
def analyze(symbol):
    ...
    try:
        ...
        # 🔥 BALANCED + REALISTIC RSI
        if trend_up and mom_up and (vol_ok or score >= 80) and 48 < rsi_val < 65:
            direction = "LONG"
        elif trend_down and mom_down and (vol_ok or score >= 80) and 35 < rsi_val < 52:
            direction = "SHORT"
        else:
            return None
