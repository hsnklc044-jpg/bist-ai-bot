# =========================================
# FILE: v1103_ULTRA_PRO_ENGINE_SILENT_MODE.py
# =========================================
...
# 🔇 TÜM YFINANCE UYARILARINI KAPAT
...
# ================= REGIME (SILENT + FALLBACK) =================
def regime_filter():
    try:
        df = yf.download("^XU100", period="1d", interval="1m", progress=False)

        # 🔥 veri yoksa sistemi durdurma
...
# ================= ENGINE =================
print("🚀 ULTRA PRO ENGINE (SILENT MODE) STARTED")
