...
def generate_signal(df):
    ...
    # 🔴 SHORT (trend yukarı ama satış başladı - YUMUŞATILDI)
    if trend == "UP" and breakdown and volume:
        return "SHORT"

    # 🟢 LONG (trend devam - GÜÇLENDİRİLDİ)
    if trend == "UP" and breakout and volume:
        return "LONG"
