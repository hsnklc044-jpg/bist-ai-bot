...
if os.path.exists(DATA_FILE):
    ...
    memory = {c:{"win":0,"loss":0} for c in COINS}
...
def calculate_score(df, symbol):
    ...
    adaptive_bonus = winrate * 20  # iyi coin boost
