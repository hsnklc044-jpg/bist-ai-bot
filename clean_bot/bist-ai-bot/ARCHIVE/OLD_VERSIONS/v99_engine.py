...
def generate_signal(df):
    ...
    # 🔥 FAKE BREAKOUT (TUZAK)
    failed_breakout = last['high'] <= prev['high']
    ...
    # 🔴 NORMAL SHORT (trend aşağıysa)
    if trend == "DOWN" and breakdown and volume:
        return "SHORT"

    # 🔥 TUZAK SHORT (trend yukarı ama dönüş sinyali)
    if trend == "UP" and breakdown and volume and failed_breakout:
        return "SHORT"
