...
# ================= ENTRY =================
def should_enter(score, trend5, trend15, trend1h, r):
    return (
        score >= 50 and
        trend5 and
        trend15 and
...
# ================= RUN =================
def run():
    send_telegram("🚀 V54 MULTI TF AKTİF")
    ...
    while True:
        try:
            for symbol in COINS:
                ...
                trend5 = trend(close5).iloc[-1]
                trend15 = trend(close15).iloc[-1]
                trend1h = trend(close1h).iloc[-1]
                ...
                if should_enter(score, trend5, trend15, trend1h, r):
                    if symbol not in OPEN_TRADES:
