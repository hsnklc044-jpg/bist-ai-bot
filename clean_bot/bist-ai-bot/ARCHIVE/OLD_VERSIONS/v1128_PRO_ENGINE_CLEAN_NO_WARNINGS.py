# =========================================
# FILE: v1128_PRO_ENGINE_CLEAN_NO_WARNINGS.py
# =========================================
...
def atr(df):
    ...
    return val(tr.rolling(ATR_PERIOD).mean().tail(1))
...
def signal(df):
    ...
    price = val(close.tail(1))
    ma_val = val(ma.tail(1))
...
print("🚀 PRO ENGINE (CLEAN) STARTED")
