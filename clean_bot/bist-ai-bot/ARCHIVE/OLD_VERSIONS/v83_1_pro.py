...
def analyze(symbol):
    ...
    try:
        ...
        # 🔥 BALANCED PROFESSIONAL LOGIC
        if trend_up and mom_up and (vol_ok or score >= 80) and 50 < rsi_val < 60:
            direction = "LONG"
        elif trend_down and mom_down and (vol_ok or score >= 80) and 40 < rsi_val < 50:
            direction = "SHORT"
        else:
            return None
