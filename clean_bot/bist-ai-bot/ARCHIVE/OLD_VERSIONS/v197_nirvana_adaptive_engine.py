...
def analyze(s):
    ...
    score=min((trend*180 + abs(momentum)*900)*score_mult,5)
...
# ================= MAIN =================
def run():
    send("🧠 v197 ADAPTIVE ENGINE STARTED")
